...
// カートに追加ボタン押下時
Route::post('/product_detail/cart', 'App\Http\Controllers\CartController@addCart')->name('add_cart');

// 購入ページ表示
Route::get('/buy', 'App\Http\Controllers\CartController@buyPageIndex')->name('buy_page');
// 購入確定ボタン押下時
Route::post('/buy_fix', 'App\Http\Controllers\CartController@buyFix')->name('buy_fix');
